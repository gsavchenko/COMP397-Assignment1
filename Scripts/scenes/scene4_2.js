...
var scenes;
(function (scenes) {
    var scene4_2 = (function (_super) {
        __extends(scene4_2, _super);
        // scene4_2 Class Contructor
        function scene4_2() {
            _super.call(this);
        }
        // Initialize scene objects
        scene4_2.prototype.start = function () {
            console.log("Scene 4-2 Started");
            ...
            // Add scene4_2 to global stage container
            stage.addChild(this);
        };
        // Mouse event handler for mouse clicks
        scene4_2.prototype._leftButtonClick = function (event) {
    ...
    scenes.scene4_2 = scene4_2;
})(scenes || (scenes = {}));
//# sourceMappingURL=scene4_2.js.map